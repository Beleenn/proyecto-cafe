...
class Negocio ():
    ...
    def __init__(self, ventana_venta):
        ...
        ventana_venta.state('zoomed')
        ventana_venta.config(bd=10, menu=menu_negocio)
        
#------------------------- Forma de Menu -----------------------------
        Productos=Menu(menu_negocio,tearoff=0)
        Ventas=Menu(menu_negocio,tearoff=0)
        Reportes=Menu(menu_negocio,tearoff=0)
        Informacion=Menu(menu_negocio,tearoff=0)
        menu_negocio.add_cascade(label="Productos", menu= Productos)
        menu_negocio.add_cascade(label="Ventas",menu=Ventas)
        menu_negocio.add_cascade(label="Reportes", menu=Reportes)
        menu_negocio.add_cascade(label="Ayuda",menu=Informacion)

        #-------------------ICONOS---------------------------------------------

        self.img_registrar=PhotoImage(file="Registrar.png")
        self.img_buscar=PhotoImage(file="Buscar.png")
        self.img_ventas=PhotoImage(file="ventas.png")
        self.img_nueva_venta=PhotoImage(file="Nueva Venta.png")
        self.img_cliente=PhotoImage(file="Cliente.png")
        self.img_codigo=PhotoImage(file="Codigo.png")
        self.img_informacion=PhotoImage(file="Informacion.png")
        ...
        self.boton_buscar= Productos.add_command(label="Buscar",command=self.widgets_buscador,image=self.img_nueva_venta,compound=LEFT)
        ...
        self.frame_logo_productos = LabelFrame(ventana_venta)
        self.frame_registro = LabelFrame(ventana_venta, text="Registrar producto",font=("Comic Sans", 10,"bold"),pady=5)
        self.frame_botones_registro=LabelFrame(ventana_venta)
        self.frame_tabla_crud=LabelFrame(ventana_venta)
        #-------------------------Buscador-----------------------------------
        self.frame_buscar_producto = LabelFrame(ventana_venta, text="Buscar Producto", font=("Arial",10, "bold"),pady=10)
        self.frame_boton_buscar = LabelFrame(ventana_venta)
        self.frame_tabla_buscador = LabelFrame(ventana_venta)
        #-----------------------Nuevas Ventas----------------------------
        self.frame_dni_venta=LabelFrame(ventana_venta)
        self.frame_nueva_venta = LabelFrame(ventana_venta,text="Nueva venta",font=("Arial", 10,"bold"),pady=10)
        self.frame_finalizar_venta=LabelFrame(ventana_venta)
        self.frame_tabla_nueva_venta=LabelFrame(ventana_venta)
        #-------------------------Ventas----------------------------------
        self.frame_buscar_ventas = LabelFrame(ventana_venta,text="Buscar venta",font=("Arial", 10,"bold"),pady=10)
        self.frame_boton_buscar_ventas=LabelFrame(ventana_venta)
        self.frame_tabla_ventas=LabelFrame(ventana_venta)
#----------------------------------------Cliente----------------------------------------
        self.frame_nuevo_cliente = LabelFrame(ventana_venta,text="Nuevo Cliente",font=("Arial", 10,"bold"),pady=10)
        self.frame_botones_registro_cliente = LabelFrame(ventana_venta)
        self.frame_buscar_cliente = LabelFrame(ventana_venta,text="Buscar Cliente",font=("Arial", 10,"bold"),pady=10)
        self.frame_tabla_clientes=LabelFrame(ventana_venta)
#----------------------------------------Productos---------------------------------------
        self.frame_codigo = LabelFrame(ventana_venta)
...
#WIDGETS
    def widgets_crud(self):
		...
		#------------------Formulario-------------------------------
        label_codigo=Label(self.frame_registro,text="Codigo del producto: ",font=("Arial", 10,"bold")).grid(row=0,column=0,sticky='s',padx=5,pady=8)
        self.codigo=Entry(self.frame_registro,width=25)
        self.codigo.focus()
        self.codigo.grid(row=0, column=1, padx=5, pady=8)
            
        label_nombre=Label(self.frame_registro,text="Nombre del producto: ",font=("Arial", 10,"bold")).grid(row=1,column=0,sticky='s',padx=5,pady=8)
        self.nombre=Entry(self.frame_registro,width=25)
        self.nombre.grid(row=1, column=1, padx=5, pady=8)
        
        label_categoria=Label(self.frame_registro,text="Categoria: ",font=("Arial", 10,"bold")).grid(row=2,column=0,sticky='s',padx=5,pady=9)
        ...
        label_cantidad=Label(self.frame_registro,text="Cantidad: ",font=("Arial", 10,"bold")).grid(row=0,column=2,sticky='s',padx=5,pady=8)
        self.cantidad=Entry(self.frame_registro,width=25)
        self.cantidad.grid(row=0, column=3, padx=5, pady=8)

        label_precio=Label(self.frame_registro,text="Precio ($): ",font=("Arial", 10,"bold")).grid(row=1,column=2,sticky='s',padx=5,pady=8)
        self.precio=Entry(self.frame_registro,width=25)
        self.precio.grid(row=1, column=3, padx=5, pady=8)

        label_descripcion=Label(self.frame_registro,text="Descripcion: ",font=("Arial", 10,"bold")).grid(row=2,column=2,sticky='s',padx=10,pady=8)
        ...
        #---------------------------- Botones Config -----------------------------
        boton_registrar=Button(self.frame_botones_registro,text="REGISTRAR",command=self.Agregar_producto,height=2,width=12,bg="green",fg="white",font=("Arial", 10,"bold")).grid(row=0, column=1, padx=10, pady=10)
        boton_editar=Button(self.frame_botones_registro,text="EDITAR",command=self.Editar_producto ,height=2,width=12,bg="gray",fg="white",font=("Arial", 10,"bold")).grid(row=0, column=2, padx=10, pady=10)
        boton_eliminar=Button(self.frame_botones_registro,text="ELIMINAR",command=self.Eliminar_producto,height=2,width=12,bg="red",fg="white",font=("Arial", 10,"bold")).grid(row=0, column=3, padx=10, pady=10)
    ...
    def widgets_buscador(self):
        ...
        label_codigo_codigo=Label(self.frame_buscar_producto,text="Codigo / Nombre del producto: ",font=("Arial", 10,"bold")).grid(row=0,column=2,sticky='s',padx=5,pady=5)
        ...
        #----------------------- Boton ----------------------------------------
        self.boton_buscar=Button(self.frame_boton_buscar,text="BUSCAR",command=self.Buscar_productos,height=2,width=20,bg="black",fg="white",font=("Arial", 10,"bold"))
    ...
    def widgets_cliente(self):
        ...
        self.label_dni=Label(self.frame_nuevo_cliente,text="DNI: ",font=("Arial", 10,"bold")).grid(row=0,column=0,sticky='s',padx=5,pady=5)
        self.dni=Entry(self.frame_nuevo_cliente,width=25)
        self.dni.focus()
        self.dni.grid(row=0,column=1,padx=5,pady=5)

        self.label_nombres=Label(self.frame_nuevo_cliente,text="Nombres: ",font=("Arial", 10,"bold")).grid(row=1,column=0,sticky='s',padx=5,pady=5)
        self.nombres=Entry(self.frame_nuevo_cliente,width=25)
        self.nombres.grid(row=1, column=1, padx=10, pady=5)

        self.label_apellidos=Label(self.frame_nuevo_cliente,text="Apellidos: ",font=("Arial", 10,"bold")).grid(row=2,column=0,sticky='s',padx=5,pady=5)
        self.apellidos=Entry(self.frame_nuevo_cliente,width=25)
        self.apellidos.grid(row=2, column=1, padx=10, pady=5)

        self.label_telefono=Label(self.frame_nuevo_cliente,text="Telefono: ",font=("Arial", 10,"bold")).grid(row=0,column=2,sticky='s',padx=5,pady=5)
        self.telefono=Entry(self.frame_nuevo_cliente,width=25)
        self.telefono.grid(row=0, column=3, padx=10, pady=5)

        self.label_email=Label(self.frame_nuevo_cliente,text="E-mail: ",font=("Arial", 10,"bold")).grid(row=1,column=2,sticky='s',padx=5,pady=5)
        self.email=Entry(self.frame_nuevo_cliente,width=25)
        self.email.grid(row=1, column=3, padx=10, pady=5)

        self.label_direccion=Label(self.frame_nuevo_cliente,text="Direccion: ",font=("Arial", 10,"bold")).grid(row=2,column=2,sticky='s',padx=5,pady=5)
        self.direccion=Entry(self.frame_nuevo_cliente,width=30)
        self.direccion.grid(row=2, column=3, padx=10, pady=5)

        #----------------------------- Frame botones -----------------------------
        self.boton_registrar=Button(self.frame_nuevo_cliente,text="REGISTRAR",command=self.Agregar_cliente,height=1,width=15,bg="green",fg="white",font=("Arial", 10,"bold"))
        self.boton_registrar.grid(row=0,column=4,padx=10,pady=5)

        self.boton_editar=Button(self.frame_nuevo_cliente,text="EDITAR",command=self.Editar_cliente,height=1,width=15,bg="gray",fg="white",font=("Arial", 10,"bold"))
        self.boton_editar.grid(row=1,column=4,padx=10,pady=5)

        self.boton_eliminar=Button(self.frame_nuevo_cliente,text="ELIMINAR",command=self.Eliminar_cliente,height=1,width=15,bg="red",fg="white",font=("Arial", 10,"bold"))
        ...
        #------------------ Buscar cliente -----------------------
        self.label_buscar_cliente=Label(self.frame_buscar_cliente,text="DNI: ",font=("Arial", 10,"bold")).grid(row=0,column=0,sticky='s',padx=20,pady=10)
        self.buscar_dni=Entry(self.frame_buscar_cliente,width=30)
        self.buscar_dni.grid(row=0, column=1, padx=30, pady=5)
        self.boton_buscar=Button(self.frame_buscar_cliente,text="BUSCAR",command=self.Buscar_cliente,height=1,width=15,bg="black",fg="white",font=("Arial", 10,"bold"))
    ...
    def widgets_codigos(self):
        ...
        imagen=Image.open("./Proyecto cafe/codigo.png")
...
#----------------------------- Titulo --------------------------------
        self.Label_titulo = Label(self.Label_informacion,text="APLICACION DE ESCRITORIO",fg="white",bg="black",font=("Arial", 23,"bold"),padx=150,pady=20)
        self.Label_titulo.grid(row=0,column=0)

#------------------------- Logos imagenes------------------------------
    #------------------------------Logo------------------------------------ 
        imagen=Image.open("./Proyecto cafe/icono.png")
        ...
        #--------------------------- opciones------------------------------
        self.Label_titulo = Label(self.Label_informacion,text="> CONTROL DE PRODUCTOS ",fg="black",font=("Arial", 16,"bold"))
        self.Label_titulo.grid(row=2,column=0,sticky=W,padx=30,pady=10)

        self.Label_titulo = Label(self.Label_informacion,text="> BUSCADOR DE PRODUCTOS ",fg="black",font=("Arial", 16,"bold"))
        self.Label_titulo.grid(row=3,column=0,sticky=W,padx=30,pady=10)

        self.Label_titulo = Label(self.Label_informacion,text="> REGISTRO VENTAS ",fg="black",font=("Arial", 16,"bold"))
        self.Label_titulo.grid(row=4,column=0,sticky=W,padx=30,pady=10)

        self.Label_titulo = Label(self.Label_informacion,text="> GENERACION DE REPORTE ",fg="black",font=("Arial", 16,"bold"))
        self.Label_titulo.grid(row=5,column=0,sticky=W,padx=30,pady=10)

        self.Label_titulo = Label(self.Label_informacion,text="Creado por Emiliano Diaz - 2023",fg="black",font=("Arial",12,"bold"))
    ...
    #--------------------- Frame marco dni_ventas ----------------------------
        ...
        label_dni_venta=Label(self.frame_dni_venta,text="DNI: ",font=("Arial", 10,"bold")).grid(row=0,column=0,sticky='s',padx=5,pady=5)
        self.dni_venta=Entry(self.frame_dni_venta,width=25)
        self.dni_venta.focus()
        self.dni_venta.grid(row=0, column=1, padx=10, pady=5)

        label_medio_pago=Label(self.frame_dni_venta,text="Medio de pago: ",font=("Arial", 10,"bold")).grid(row=0,column=2,sticky='s',padx=5,pady=5)
        ...
        label_codigo_producto_venta=Label(self.frame_nueva_venta,text="Codigo: ",font=("Arial", 10,"bold")).grid(row=0,column=0,sticky='s',padx=5,pady=5)
        ...
        label_cantidad_producto_venta=Label(self.frame_nueva_venta,text="Cantidad: ",font=("Arial", 10,"bold")).grid(row=1,column=0,sticky='s',padx=5,pady=5)
        ...
        self.boton_agregar_producto_venta=Button(self.frame_nueva_venta,text="AGREGAR",command=self.Agregar_producto_venta,height=1,width=15,bg="green",fg="white",font=("Arial", 10,"bold"))
        self.boton_agregar_producto_venta.grid(row=0,column=2,padx=5,pady=5)

        self.boton_eliminar_producto_venta=Button(self.frame_nueva_venta,text="ELIMINAR",command=self.Eliminar_producto_venta,height=1,width=15,bg="red",fg="white",font=("Arial", 10,"bold"))
 ...
 #--------------- Finalizar venta --------------------"
        ...
        self.boton_finalizar_venta=Button(self.frame_finalizar_venta,text="Finalizar venta",command=self.Finalizar_venta,height=2,width=15,bg="black",fg="white",font=("Arial", 12,"bold"))
    ...
    #--------------------- Formulario Buscar ventas-----------------------
        self.label_buscar_venta=Label(self.frame_buscar_ventas,text="Buscar Por: ",font=("Arial", 10,"bold")).grid(row=0,column=0,sticky='s',padx=5,pady=5)
        ...
        label_dni_fecha=Label(self.frame_buscar_ventas,text="DNI / Fecha: ",font=("Arial", 10,"bold")).grid(row=0,column=2,sticky='s',padx=5,pady=5)
    ...
    #--------------- Frame para marco ventas--------------------
        self.frame_boton_buscar_ventas.config(bd=0)
        self.frame_boton_buscar_ventas.grid(row=2,column=0,padx=5,pady=5)
    #--------------- Boton de ventas ----------------------------
        self.boton_buscar_ventas=Button(self.frame_boton_buscar_ventas,text="BUSCAR",command=self.Buscar_venta,height=2,width=20,bg="black",fg="white",font=("Arial", 10,"bold"))
...
#-------------- CRUD --------------------               
    ...
    def Editar_producto(self):
        ...
        label_codigo=Label(self.Ventana_editar,text="Codigo del producto: ",font=("Arial", 10,"bold")).grid(row=0,column=0,sticky='s',padx=5,pady=8)
        ...
        label_nombre=Label(self.Ventana_editar,text="Nombre del producto: ",font=("Arial", 10,"bold")).grid(row=1,column=0,sticky='s',padx=5,pady=8)
        ...
        label_categoria=Label(self.Ventana_editar,text="Categoria: ",font=("Arial", 10,"bold")).grid(row=2,column=0,sticky='s',padx=5,pady=9)
        ...
        label_cantidad=Label(self.Ventana_editar,text="Cantidad: ",font=("Arial", 10,"bold")).grid(row=0,column=2,sticky='s',padx=5,pady=8)
        ...
        label_precio=Label(self.Ventana_editar,text="Precio ($): ",font=("Arial", 10,"bold")).grid(row=1,column=2,sticky='s',padx=5,pady=8)
        ...
        label_descripcion=Label(self.Ventana_editar,text="Descripcion: ",font=("Arial", 10,"bold")).grid(row=2,column=2,sticky='s',padx=10,pady=8)
...
#--------------- CLIENTES-------------------------
    ...
    def Editar_cliente(self):
        ...
        #----------Valores ventana editar-----------------------
        label_dni=Label(self.Ventana_editar_cliente,text="DNI: ",font=("Arial", 10,"bold")).grid(row=0,column=0,sticky='s',padx=5,pady=8)
        ...
        label_nombres=Label(self.Ventana_editar_cliente,text="Nombres: ",font=("Arial", 10,"bold")).grid(row=1,column=0,sticky='s',padx=5,pady=8)
        ...
        label_apellidos=Label(self.Ventana_editar_cliente,text="Apellidos: ",font=("Arial", 10,"bold")).grid(row=2,column=0,sticky='s',padx=5,pady=9)
        ...
        label_telefono=Label(self.Ventana_editar_cliente,text="Telefono: ",font=("Arial", 10,"bold")).grid(row=0,column=2,sticky='s',padx=5,pady=8)
        ...
        label_email=Label(self.Ventana_editar_cliente,text="E-mail: ",font=("Arial", 10,"bold")).grid(row=1,column=2,sticky='s',padx=5,pady=8)
        ...
        label_direccion=Label(self.Ventana_editar_cliente,text="Direccion: ",font=("Arial", 10,"bold")).grid(row=2,column=2,sticky='s',padx=10,pady=8)
        ...
        boton_actualizar_cliente=Button(self.Ventana_editar_cliente,text="ACTUALIZAR",command= lambda: self.Actualizar_cliente(nuevo_dni.get(),nuevo_nombres.get(),nuevo_apellidos.get(),nueva_telefono.get(),nuevo_email.get(),nueva_direccion.get(),dni,nombres),height=2,width=20,bg="black",fg="white",font=("Arial", 10,"bold"))
